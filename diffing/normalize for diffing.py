...
def contents(path, *args, encoding='utf-8', **kwargs):
    with reading (path, *args, encoding=encoding, **kwargs) as f:
        return f.read()
# (CLOSE)
# (OPEN) :reading
def reading(path, *args, encoding='utf-8', **kwargs):
    return path.open('r', *args, encoding=encoding, **kwargs)
# (CLOSE)
# (OPEN) :realpath
...
# (CLOSE)
# (OPEN) :set_contents
def set_contents(path, string, *args, encoding='utf-8', newline='\n', **kwargs):
    with writing (path, *args, encoding=encoding, newline=newline, **kwargs) as f:
        f.write(string)
# (CLOSE)
# (OPEN) :sleep
def sleep(secs):
...
# (CLOSE)
# (OPEN) :writing
def writing(path, *args, encoding='utf-8', newline='\n', **kwargs):
    return path.open('w', *args, encoding=encoding, newline=newline, **kwargs)
# (CLOSE)
# (CLOSE)
